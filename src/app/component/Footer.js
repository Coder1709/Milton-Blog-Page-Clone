...
export default function Footer() {
  return (
    <footer className="bg-blue-100 border border-black-100">
        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <a className="flex items-center">
              <span className="self-center  text-sm whitespace-nowrap text-gray-600">
                A short text explaining why{" "}
              </span>
            </a>
            <a className="flex items-center">
              <span className="self-center  text-sm whitespace-nowrap text-gray-600">
